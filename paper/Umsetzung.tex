...
@todo(viktor): Warum nicht nur jede Zelle mit 8 nächsten Verbinden? keine garantie dass a's nächster Nachbar b auch a als nächsten Nachbar hat. Müssen Nachbarn immer bidirektional sein? einseitige Benachbarungen?
\begin{itemize}
...
@todo(viktor): Warum planare Graphen? und Warum generieren?
...
Für den Algorithmus ist diese Unterscheidung egal und er generiert die gleiche Art von Ausgaben ohne weitere Anpassungen. @visual
...
@incomplete Eigenschaften einer Delauney-Triangulierung nennen
...
\begin{itemize}
    ...
    \item Nun können gedrehte regelmäßige Gitter auch gelöst werden. (Siehe Grid = Square with an angle ~27° and strictness(@naming) 1 or 2).
