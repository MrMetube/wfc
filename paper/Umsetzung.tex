...
@todo(viktor): Warum nicht nur jede Zelle mit 8 nächsten Verbinden? keine garantie dass a's nächster Nachbar b auch a als nächsten Nachbar hat. Müssen Nachbarn immer bidirektional sein? Future Work mit unidirektionalen Benachbarungen?
\begin{itemize}
