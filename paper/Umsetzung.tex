...
\begin{itemize}
    ...
    \item Hierfür erstelle ich eine Tabelle mit drei Axen. Die ersten beiden sind die zu vergleichenden Zustände, die dritte bestimmt die Himmelsrichtung(@naming) entlang der ich diese vergleiche.
...
\section{Overlap - Direction Mask / State Buckets?}
\begin{itemize}
