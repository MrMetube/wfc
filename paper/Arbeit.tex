...
\chapter{Zusammenfassung und Ausblick}
    \at{@incomplete bin ich zufrieden, was am algorithmus ist gut(hex und so läuft super), wo sind schwachstellen(noise graph)}
    
    \section{zukünftige Forschung}
    \at{@incomplete alles ausformulieren. Also Fragen oder Probleme meines Algorithmus formulieren sollte reichen}
    
    
    \begin{itemize}
    \item Mögliche Anwendungsbereiche, in 3D
    \item Beispiel auch als Graph? Graph dynamisch, basiert auf dem Beispiel generieren?
    ...
    \item Globale Heat steht in direkter verbindung mit uniformen Graphen. Ebend weil unregelmäßigkeit, nicht mit einem Wert gedeckelt werden kann
