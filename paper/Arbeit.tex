...
\usepackage{microtype}      % besseres Satzbild
...
\chapter{Hintergrund \at{@naming} Beispielbasierte prozedurale generierung?}
    ...
    \section{Delaunay Triangulierung, Voronoi Diagramm}
        \url{https://en.wikipedia.org/wiki/Delaunay_triangulation}\\
        \url{https://en.wikipedia.org/wiki/Voronoi_diagram}\\
        
        Delaunay Triangulation \at{@incomplete Definition, Algorithmus und @visual @citation}
            
        Voronoi Diagramm \at{@incomplete Definition, nützliche Eigenschaften @visual @citation}
