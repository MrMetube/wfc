...
\chapter{Umsetzung}
    ...
    \section{Phasen und Backtracking}
        ...
        In der Observe-Phase wird ein Zustand aus der Superposition der gewählten Zelle zufällig ausgewählt und die Zelle wird in diesen Zustand collapsed. Die anderen Zustände werden entfernt, was Einfluss auf die Nachbarzellen haben kann. Die Wahrscheinlichkeit eines Zustands, gewählt zu werden, hängt von dessen Häufigkeit im Beispiel ab. 
...
\chapter{Ergebnisse und Diskussion}
    ...
    \begin{itemize} 
    % Ergebnisse
    \item Base Case - Gitter - Vergleich zum WFC
