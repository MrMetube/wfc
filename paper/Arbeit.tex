...
\section{Hintergrund \at{@naming} Beispielbasierte prozedurale generierung?}
    ...
    \subsection{Model Synthesis}
        ...
        Die selbe Methodik kann auch auf 2D Gittern angewendet werden; dies wird dann auch \textit{Texture Synthesis} genannt. Desweiteren kann der Algorithmus um andere Techniken der prozeduralen Generierung erweitert werden, so können z.B. andere beliebige Beschränkungen auf die Ausgabe angewendet werden. \at{@visual}
