...
\section{Umsetzung}
    ...
    \subsection{Generierung von Graphen \at{@naming}}
        ...
        Generier eine Menge an 2D Punkten
        Erstell die Delaunay Triangulierung
            Bowyer-Watson
        Finde das Voronoi Diagramm
            Clipping
        Presto!
        ...
        Für die Triangulierung habe ich mich ohne tiefere Beweggründe für den Boywer-Watson Algorithmus \at{@citation} entschieden. Der Algorithmus generiert die Triangulierung iterativ in dem jeder Punkt nacheinander eingefügt wird und der Graph angepasst wird, so dass es wieder eine Delaunay-Triangulierung ist.
