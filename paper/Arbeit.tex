...
\chapter{Wave Function Collapse auf Graphen}
    ...
    \section{Heat}
        ...
        \at{@incomplete Zusammenhang von Heat und Entropie}
...
\chapter{Ergebnisse und Diskussion}
    ...
    \section{Übersicht / Auswertung \at{@naming}}
        Im folgenden Abschnitt werden \at{@incomplete siehe Abbildungen \ref{fig:results_1} und \ref{fig:results_2}}
        ...
        \item erste spalte zeigt das Beispiel und danach kommen ausgewählte Ausgaben mit dem Beispiel und dem Graph
        \item maximal eine Minute laufen lassen, wenn nicht geschafft dann mit dnf markiert
...
\chapter{Zusammenfassung und Ausblick}
    ...
    \section{Zukünftige Forschung}
        Im folgenden Abschnitt werden einige bestehende Probleme der präsentierten Methode genannt und offene Fragen formuliert.
