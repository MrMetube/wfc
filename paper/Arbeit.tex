...
\usepackage[ngerman]{babel} % 'ngerman' für neue deutsche Rechtschreibung
\usepackage{lmodern} % vector fonts
\usepackage{microtype} % bessere Satzbild
% \usepackage{csquotes} % deutsche Anführungszeichen mit babel
...
\chapter{Hintergrund \at{@naming} Beispielbasierte prozedurale generierung?}
    ...
    \section{Gitter, Graphen, Triangulierung, Voronoi}
        \at{@placement Gitter und Knoten und so wird bereits bei Model Synthesis gebraucht}
...
\chapter{Wave Function Collapse auf Graphen}
    ...
    \section{Heat \at{@naming}}
        ...
        Es bleibt also nur die Möglichkeit, dass der tatsächlichen Richtung eine der messbaren Himmelsrichtungen zugewiesen wird. Hierfür wird die Kosinus-Ähnlichkeit \cite{cosine} \ref{fig:cosine} \at{@incomplete genauer erklären was Kosinus Ähnlichkeit ist} berechnet. Es wird die Himmelsrichtung mit der höchsten Ähnlichkeit gewählt. \at{@incomplete Kann auch mehr als eine Richtung sein}. \at{@incomplete Globale Heat}
        
        \input{data/cosine.tex}

    \section{Überblick \at{@naming}}
