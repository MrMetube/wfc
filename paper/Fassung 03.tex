...
\subsubsection{Output Graphen \at{@naming}}
...
\subsection{Regelextrahierung \at{@naming}}
    \at{@translation} Eingabe nennt Merrel Example, also wäre Beispiel vielleicht besser
    \at{@citation merrel}
    ...
    Für jeden Pixel der Eingabe wird sein Umfeld notiert. Die Frequenz eines Umfelds stellt die Anzahl an Pixeln in der Eingabe mit diesem Umfeld dar. Aus der Gesamtanzahl an Muster und deren Frequenzen lässt sich die Wahrscheinlichkeit jedes Umfelds berechen. Dies wird im Collapse genutzt, damit nicht nur lokale Ähnlichkeit sondern auch die globale Verteilung von Umfeldern der Eingabe ungefähr ähnelt (\at{@incomplete} das nicht nur hier so knapp sagen sondern auch später nochmal erwähnen). 
    
    \at{@incomplete} Algorithmus zur Extrahierung genauer und was zu Wrapping
    
    \at{@incomplete} \at{@visual} Grafik zur Erklärung
    ...
    \at{@incomplete} Symmetrie der Regeln
    \at{@incomplete} Transitivität der Regeln
...
\subsection{Collapse Cells - Step \at{@naming}}
    ...
    Zu Beginn wird die Zelle mit der geringsten Entropie gesucht, die noch nicht collapsed\at{@translation} ist. Die Entropie einer Zelle wird als die Shannon-Entropy \at{@citation} der noch möglichen Zustände berechnet. 
