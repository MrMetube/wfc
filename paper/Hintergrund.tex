...
\subsection{Stand der Technik - Geschichte - Hintergrund}
...
\subsubsection{Maxim Gumin}
\begin{itemize}
    \item WFC - Renaming and popularization
    \item Overlapping tiles in extraction and for support checking
...
\subsubsection{Delaunay Triangulation - Bowyer-Watson Algorithmus}
\begin{itemize}
...
??? Will ich das wirklich mit einbringen ???
