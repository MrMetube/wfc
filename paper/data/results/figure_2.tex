\begin{figure}[H]
    ...
    \hfill
    \begin{subfigure}{0.04\textwidth} \includegraphics[width=\linewidth]{data/results/011.png} \end{subfigure}
    ...
    \hfill
    \begin{subfigure}{0.04\textwidth} \includegraphics[width=\linewidth]{data/results/012.png} \end{subfigure}
    ...
    \hfill
    \begin{subfigure}{0.04\textwidth} \includegraphics[width=\linewidth]{data/results/013.png} \end{subfigure}
