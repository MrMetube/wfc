\begin{figure}[H]
    ...
    \caption{
        Extraktion mit N=3 und vertikalem Wrapping. (a,e) Umfeld 1($U_1$) ergibt einen Zustand 1 ($Z_1$). Da die anderen Umfelder anders sind hat $Z_1$ nur eine Frequenz von 1. (d) $U_4$ überschreitet den Rand und nimmt die Pixel aus der ersten Reihe. (f) $U_2$ und $U_3$ sind gleich, darum hat $Z_2$ eine Frequenz von 2.
    }
