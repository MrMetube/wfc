\begin{figure}[H]
    ...
    \begin{minipage}{\linewidth}
        ...
        \@todo(viktor):{genauer ausformulieren}
        \begin{enumerate}
            \item \at{@incomplete schritt nummer startet bei 0}
            \item Führe den nächsten \textbf{Schritt} aus: \begin{enumerate}
                \item \textbf{Search}: Finde die Zellen mit der geringsten Entropie \begin{enumerate}
                    \item Sind alle Zellen collapsed $\rightarrow$ \textbf{Done}
                ...
                \item \textbf{Propagate}: Prüfe alle Nachbarn von geänderten Zellen \begin{enumerate}
                    ...
                    \item Ist die Superpostition des Nachbars nun leer $\rightarrow$ \textbf{Backtrack}
                \end{enumerate}
                
                \item Geh zum nächsten \textbf{Schritt} \at{@incomplete schritt nummer hoch}
            \end{enumerate}
            \item \textbf{Backtrack}: \begin{enumerate}
                \item Gehe zum gewünschten Schritt zurück \at{@incomplete schritt nummer}
                \item Gehe eine Phase in dem Schritt zurück
                \item Füge alle Zustände aller Zellen, dessen Entfernungszeitpunkt nun in einem zukünftigen Schritt liegt, wieder in die Superposition der Zelle ein
            \end{enumerate}
