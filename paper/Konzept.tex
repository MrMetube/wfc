...
@todo(viktor): Müssen es planare Graphen sein? Nein, ein Quadratgitter mit allen 8 Diagonalen pro Zelle ist ja auch okay, nur Delaunay macht daraus immer nur Ecken mit 4 bis 8 Kanten.
...
@todo(viktor): Warum brauchen wir Heat. Welchen Effekt hat eine Heat von 1 auf z.B. Hexagongitter oder ''Rauschgraphen''

\subsection{Output Graphen @naming}
...
@incomplete Entropy erwähnen und für Regionen mit einer Grafik von der App darstellen

@todo(viktor): Collapsed und Observed als Begriffe vereinheitlichen


\subsection{Regelextrahierung}
@todo(viktor): @placement vielleicht aufteilen in Allgemeines vom WFC und meine Abänderungen\\
@todo(viktor): Kurz was zu Nachbarschaft \\
\url{https://en.wikipedia.org/wiki/Von_Neumann_neighborhood} und \\
...
\begin{itemize}
    ...
    \item 
    \item @incomplete Algorithmus zur Extrahierung und Wrapping
    \item @incomplete Frequenz von Zuständen
    \item 
    ...
    \item @incomplete Grafik zur Erklärung
    \item 
    ...
    \item 
    \item @incomplete Welche Richtungen sind erlaubt?
    \item 
    ...
    \subitem @incomplete Symmetrie der Regeln
    ...
    \item 
    \item @incomplete Darstellung in der Ausgabe
\end{itemize}
